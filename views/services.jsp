			...
			<div class="container">
				...
				<div class="row text-center">
					<div class="col-md-4 animate-box">
						<a href="#" class="grid-photo" style="background-image: url(./resources/images/pic4.jpg);">
							<div class="desc">
								<h3>Camera</h3>
								<span>12 Photos</span>
							</div>
					...
					<div class="col-md-4 animate-box">
						<a href="#" class="grid-photo" style="background-image: url(./resources/images/pic5.jpg);">
							<div class="desc">
								<h3>Wedding</h3>
