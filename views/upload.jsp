...
<%@taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
			...
			<div class="container">
				...
				<div class="row">
					<div class="services">
							...
							<div id="drop-area">
							<!-- form:form method="post" action="${contextPath}/user/upload/" modelAttribute="uploadForm" enctype="multipart/form-data"-->
							 <form class="my-form" action="${contextPath}/user/upload/" method="POST" enctype="multipart/form-data">
							    <p>Upload multiple files with the file dialog or by dragging and dropping images onto the dashed region</p>
							    <input type="file" id="fileElem" name="bill_image" multiple accept="image/*" onchange="handleFiles(this.files)">
	...
	<script src="<%=request.getContextPath()%>/resources/js/abc.js"></script>
	</body>
</html>
