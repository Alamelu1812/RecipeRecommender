...
<form action="${contextPath}/user/updateinventory/" method="POST">
<c:set var="ingredients" value="${sessionScope.ingredients}" />

<c:forEach items="${sessionScope.ingredients}" var="ingredient">
<div>
<input type="checkbox" name="ingredientCheck" value="${ingredient.ingredientId}"> 
${ingredient.ingredientId}</input>
<input type="text"  value="${ingredient.ingredientName}" disabled/>
</div>
...
<input type="submit" value="FETCH" name="action"/>
							...
							<!-- form action="${contextPath}/user/removeinventory/" method="POST">
							<c:set var="ingredients" value="${sessionScope.ingredients}" />
