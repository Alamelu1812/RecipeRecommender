...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<div id="fh5co-page">
		...
		<div id="fh5co-services-section">
			<div class="container">
				<form action="${contextPath}/user/" method="GET">
				<div class="row">
					<div class="services">
							<span><i class="icon-video-camera2"></i></span>
							<h3>Your bill image has been uploaded successfully. Please check your inventory</h3>
							<a href="../login/inventory"><h3>Check Inventory</h3></a>
