			...
			<div class="container">
				...
				<div class="row text-center">
					<div class="col-md-4 animate-box">
						<a href="#" class="grid-photo" style="background-image: url(./resources/images/pic7.jpg);">
							<div class="desc">
								<h3>Camera</h3>
								<span>12 Photos</span>
							</div>
					...
					<div class="col-md-4 animate-box">
						<a href="#" class="grid-photo" style="background-image: url(./resources/images/pic8.jpg);">
							<div class="desc">
								<h3>Wedding</h3>
					...
					<div class="col-md-4 animate-box">
						<a href="#" class="grid-photo" style="background-image: url(./resources/images/pic12.jpg);">
							<div class="desc">
								<h3>Drinks</h3>
								<span>45 Photos</span>
							</div>
					...
					<div class="col-md-4 animate-box">
						<a href="#" class="grid-photo" style="background-image: url(./resources/images/pic14.jpg);">
							<div class="desc">
								<h3>Wedding</h3>
								<span>100 Photos</span>
							</div>
					...
					<div class="col-md-4 animate-box">
						<a href="#" class="grid-photo" style="background-image: url(./resources/images/pic11.jpg);">
							<div class="desc">
								<h3>Drinks</h3>
								<span>45 Photos</span>
							</div>
